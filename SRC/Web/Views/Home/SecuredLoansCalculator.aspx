...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="main">
        <div id="content" style="margin-left: 5px;">
            ...
            <input name="loanAmount" id="loanAmount"  style="width:70px;" />
            <label for="loanTerms">
                Loan Terms</label>
            <%= Html.GBFLoanTermCountDropDownList(3,24).Name("loanTerms").IsUseSelfContainer(false).Render()%>
            <%= Html.GBFPersonalLoanTermTypeDropDownList().Name("loanTermType").Lable("Per").IsUseSelfContainer(false).Render()%>
